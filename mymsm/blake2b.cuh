...
__device__ int blake2b_init_param(blake2b_state *S, const blake2b_param *P)
{
...
__device__ int blake2b_update(blake2b_state *S, const void *pin, size_t inlen)
{
...
__device__ int blake2b_is_lastblock(const blake2b_state *S)
{
  return S->f[0] != 0;
}
__device__ void blake2b_set_lastnode(blake2b_state *S)
{
  S->f[1] = (uint64_t)-1;
}
...
__device__ int blake2b_final(blake2b_state *S, void *out, size_t outlen)
{
...
__device__ int blake2b(void *out, size_t outlen, const void *in, size_t inlen, const void *key, size_t keylen)
{
  blake2b_state S[1];
...
/**
 * This is the blake2b512 api, without key[]
 */
// int blake2b_api(void *out, size_t outlen, const void *in, size_t inlen)
// {
//   return blake2b(out, outlen, in, inlen, NULL, 0);
// }
// void print_blake2b(uint8_t *buf, uint8_t len){
//  for (int i = 0; i < len; i++)
//   {
//     printf("%02X", buf[i]);
//   }
